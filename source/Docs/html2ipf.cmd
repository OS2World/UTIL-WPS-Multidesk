...
/***** Global.WWWbrowser = 'explore.exe*IBM Web Explorer'; */
...
/* font for url links (which launches WebExplorer)                    */
 Global.URLinkFont  = ':font facename=''System VIO'' size=24x14.'
...
ShowHeader:
 call SetColor white
 say 'ÄÅÄ HTML2IPF ÄÅÄ Version 0.1.1 ÄÅÄ Copyright (c) 1997 by FRIENDS software ÄÅÄ'
return;
...
/* make a chapter with links to internet locations */
 ...
 call putline 'either link is a Uniform Resource Locator (URL) or simply a';
...
/* Sort URLs alphabetically */
 ...
 do i = 1 to Global.URLinks
  j = Global.URLinks.i;
  call putline ':h2 res='GetLinkID(Global.LinkID.j)'.'IPFstring(Global.LinkID.j.RealName);
  call putline Global.DefaultFont;
...
/* Remember the count of SUBLINKS and NOSUBLINKS to restore it later */
 ...
 if id > 0
  then do
        ...
        call putline ':h'i' res='id||j'.'Global.Article.Title;
       end;
 call putline Global.DefaultFont;
 call putline ':p.';
